...
public class Web3ImplRpcTest {
    ...
    public void getRpcModules() {
        ...
        Web3Impl web3 = new Web3RskImpl(eth, blockchain, pendingState, new RskSystemProperties(), null, null, pm, null, null, repository, null, null, null, null, null, null, null, null);
