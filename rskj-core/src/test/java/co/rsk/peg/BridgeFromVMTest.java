...
public class BridgeFromVMTest {
    ...
    private Program runBridgeCallFromContract(boolean isRfs90) {
        ...
        RskSystemProperties.CONFIG.setBlockchainConfig(testConfig);
        ...
        invoke.getRepository().saveCode(invoke.getOwnerAddress().getLast20Bytes(), callerCode);
        ...
        Program program = new Program(code, invoke, tx);
