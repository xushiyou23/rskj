...
public class Web3ImplSnapshotTest {
    ...
    private static Web3Impl createWeb3(World world, SimpleEthereum ethereum, MinerServer minerServer) {
        ...
        return new Web3Impl(ethereum, world.getBlockChain(), null, world.getBlockChain().getBlockStore(), null, Web3Mocks.getMockProperties(), minerClient, minerServer, pm, null, Web3Mocks.getMockChannelManager(), ethereum.repository, null, null, null, null, null);
    }
