...
public class Web3ImplScoringTest {
    ...
    private static Web3Impl createWeb3(PeerScoringManager peerScoringManager) {
        ...
        return new Web3RskImpl(rsk, world.getBlockChain(), null, config, Web3Mocks.getMockMinerClient(), Web3Mocks.getMockMinerServer(), pm, em, Web3Mocks.getMockChannelManager(), rsk.getRepository(), peerScoringManager, null, null, null, null, null, null, null);
    }
