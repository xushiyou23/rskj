...
public class ContractDetailsImpl implements ContractDetails {
    ...
    public final void decode(byte[] rlpBytes) {
        ...
        if (this.externalStorage) {
            Sha3Hash snapshotHash = new Sha3Hash(rlpStorage.getRLPData());
    ...
    public synchronized ContractDetails getSnapshotTo(byte[] hash) {
        ...
        ContractDetailsImpl details = new ContractDetailsImpl(this.config, this.address, this.trie.getSnapshotTo(new Sha3Hash(hash)), this.code);
