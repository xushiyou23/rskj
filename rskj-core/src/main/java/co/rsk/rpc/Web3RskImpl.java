...
public class Web3RskImpl extends Web3Impl {
    ...
    public Web3RskImpl(Ethereum eth,
        ...
        super(eth, blockchain, pendingState, blockStore, receiptStore, properties, minerClient, minerServer, personalModule, ethModule, channelManager, repository, peerScoringManager, peerServer, nodeBlockProcessor, hashRateCalculator, configCapabilities);
